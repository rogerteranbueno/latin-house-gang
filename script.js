...
const BEATPORT_SVG  = `<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-1.5 6.75h3.375c2.25 0 3.375 1.063 3.375 2.813 0 .984-.469 1.734-1.266 2.109.984.375 1.641 1.219 1.641 2.344 0 1.875-1.266 2.859-3.516 2.859H10.5V6.75zm1.594 1.5v2.578h1.64c.938 0 1.407-.422 1.407-1.29 0-.843-.469-1.288-1.406-1.288h-1.641zm0 4.031v2.813h1.875c1.031 0 1.594-.47 1.594-1.406 0-.938-.563-1.407-1.594-1.407h-1.875z"/></svg>`;

function initSocialIcons() {
  const spotifyLink   = `<a href="${LHG_SPOTIFY}"    target="_blank" rel="noopener" aria-label="Spotify">${SPOTIFY_SVG}</a>`;
  const bpLink        = `<a href="${LHG_BEATPORT}"   target="_blank" rel="noopener" aria-label="Beatport">${BEATPORT_SVG}</a>`;
  ...
  const scLink        = `<a href="${LHG_SOUNDCLOUD}" target="_blank" rel="noopener" aria-label="SoundCloud">${SOUNDCLOUD_SVG}</a>`;

  const allIcons = spotifyLink + bpLink + appleLink + youtubeLink + scLink;
